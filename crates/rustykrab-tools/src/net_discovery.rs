...
impl Tool for NetDiscoveryTool {
    ...
    fn description(&self) -> &str {
        "Discover hosts, services, and devices on the local network. DNS lookups, mDNS/DNS-SD, \
         ...
         queries, and unified multi-source discovery pipeline."
    }
