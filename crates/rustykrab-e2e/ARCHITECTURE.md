...
*12 files · 7,245 lines · 37 tests · depends on `store`.*
...
The launcher resolves the checkout's exact Git SHA and the artifact writer
embeds it as `source_revision` in every JSON object, binding those observations
