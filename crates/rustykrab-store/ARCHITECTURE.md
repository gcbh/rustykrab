...
database path, and hands out thirteen narrow repository types:
...
name/label guard, not comprehensive payment-data detection. No card table,
CVV retention mechanism or reusable payment-vault API is introduced.
