...
*16 files · 9,315 lines · 120 tests · depends on `core`, `projects`.*
...
of truth. Restart, replay, conflict, and atomic-rejection tests exercise the
persistence contract against a reopened database.
